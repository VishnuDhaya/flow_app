...
def to_xls(file_name):
    with open(file_name, 'r') as file:
        data = file.read().replace('&nbsp;', '')
    
    data_dict = html_table_to_excel(data)
    export_to_xls(data_dict)

path = "/home/sateesh/Documents/PROJECTS/python/2019-06-29/2019 04 12/AccountTransaction-138.xls"
to_xls(path)